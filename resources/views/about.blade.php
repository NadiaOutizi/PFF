...
@section('content')
<div class="container" >
    <section id="hero" class="d-flex align-items-center landing">

        <div class="container">
          <div class="row">
            <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1 data-aos="fade-up">Grow your mind with us</h1>
              <h2 data-aos="fade-up" data-aos-delay="400" style="color:black">
                Lorem ipsum dolor sit amet, 
                consectetur adipisicing elit. Et quo ab quisquam voluptas! 
            </h2>
            <button class="btn-cssbuttons primary">
                ...
                <ul>
                <li>
                  <a href="#"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" class="icon">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
              <img src="{{asset('images/hero-img.gif')}}" class="img-fluid animated" alt="">
            </div>
          </div>
        </div>
...
<div class="statistics">
  <h2 class="main-title" style="font-size:25px;margin-bottom:50px">
                  Statistics
          </h2>
      <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 col-xl-4 col-md-6 col-sm-6">
              <div class="box">
                  <i class="fa fa-table fa-3x fa-fw"></i>
            ...
            <div class="col-lg-6 col-xl-4 col-md-6 col-sm-6">
              <div class="box">
                  ...
                  <span class="number"> {{ $newsCount }} </span>
                  <span class="text">
                                                  News
                                          </span>
              </div>
            ...
            <div class="col-lg-6 col-xl-4 col-md-6 col-sm-6">
              <div class="box">
                  ...
                  <span class="number">{{ $participantsCount }}</span>
                  <span class="text">
                                                  Bookings
                                          </span>
              </div>
...
<p id='p'>Check our gallery from the recent events</p>
<div class="carousel">
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/1.jpg" alt="Image 1">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/2.jpg" alt="Image 2">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/8.jpg" alt="Image 3">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/3.jpg" alt="Image 3">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/4.jpg" alt="Image 3">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/5.jpg" alt="Image 3">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/6.jpg" alt="Image 3">
  </div>
  <div class="carousel-item">
    <img src="https://bootstrapmade.com/demo/templates/TheEvent/assets/img/gallery/7.jpg" alt="Image 3">
  </div>
...
// Example of using buttons to navigate the carousel
...
// Automatically move to the next item every 3 seconds (adjust as needed)
